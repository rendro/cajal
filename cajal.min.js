...
0,this.canvas.width,this.canvas.height);this.isEmpty=true;return this},animate:function(a,b){this.loopAddAnimation(a,b);return this},stop:function(a){for(i in this.loopAnimations)if(this.loopAnimations[i].callback===a){delete this.loopAnimations[i];return this}return false},loopInterval:null,loopAnimationExists:function(a){for(i in this.loopAnimations)if(this.loopAnimations[i].callback===a)return true;return false},loopAddAnimation:function(a,b){if(!this.loopAnimationExists(a)){this.loopAnimations.push({callback:a,
duration:b||-1,frame:0});if(this.loopInterval===null){var c=this;this.loopInterval=setInterval(function(){c.loop()},Math.round(1E3/this.options.loopFps))}}},loop:function(){this.loopFrame++;for(i in this.loopAnimations){var a=this.loopAnimations[i];a.frame++;if(a.duration>0&&a.frame>a.duration)delete this.loopAnimations[i];else a.callback.apply(this,[a.frame,a.duration])}this.draw();if(this.loopAnimations.length===0){clearInterval(this.loopInterval);this.loopInterval=null}}});e.LinearGradient=function(a,
...
0?null:{x:a,y:b};return this},options:function(a){e.extend(this.drawOptions,a);return this},prepare:function(a,b){var c=a.ctx;c.save();c.globalAlpha=a.options.globalAlpha;c.globalCompositeOperation=a.options.globalCompositeOperation;if(this.itemOptions.hidden!==true){b=b!==undefined?e.extend({},this.drawOptions,b):this.drawOptions;if(b.fill!==null)c.fillStyle=typeof b.fill==="object"?b.fill.draw(c):e.isFunction(b.fill)?b.fill.apply(this,[c]):b.fill;if(b.stroke!==null){c.strokeStyle=typeof b.stroke===
